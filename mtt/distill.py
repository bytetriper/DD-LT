...
def main(args):
    ...
    for it in range(0, args.Iteration+1):
        ...
        # print('# ', student_params, starting_params)
        for step in range(args.syn_steps):
            ...
            # print('step ', step, student_params[-1], syn_lr, grad, ce_loss)
        ...
        # print('@ 1', param_loss)
        # print(student_params[-1], target_params)
        ...
        # print('@ 2', num_params, param_dist, param_loss)
        ...
        if syn_lr.item() < 0:
            # print("Warning: Learning rate became negative. Clamping to 1e-4.")
            syn_lr.data.clamp_(min=1e-4)
            # syn_lr.data = F.softplus(syn_lr.data)
